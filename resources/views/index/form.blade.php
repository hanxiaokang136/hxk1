...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     <form method="post" action="{{url('dao_add')}}" onsubmit="return fun()">
    <ul class="forminfo">
    <li><label>导航标题</label><input name="nav_name" type="text" class="dfinput"id="nav_name" onblur="fun1()"/><i id="s_nav_name">标题不能为空</i></li>
    <li><label>导航链接</label><input name="nav_url" type="text" class="dfinput" id="nav_url" onblur="fun2()"/> <i id="s_nav_url">链接不能为空</i></li>
    ...
    <li><label>导航描述</label><textarea name="desc" cols="" rows="" class="textinput" id="desc"  onblur="fun3()"></textarea><i id="s_nav_desc">描述不能为空</i></li>
