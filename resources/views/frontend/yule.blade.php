...
<div class="container ie-dropdown-fix">
	...
	<div class="sixteen columns">
		...
		<div id="navigation">
			<ul id="nav">
                             @foreach($yule_nav_resources as $k=>$v)
...
<div class="container">
	...
	<div class="sixteen columns">
		...
		<!-- Page Title -->
		<div id="page-title">
			<h2>Portfolio <span>/ 2 Columns</span></h2>
...
<div class="container">
	...
	<div id="portfolio-wrapper">
		...
		<div class="eight columns portfolio-item interior-design architecture">
			<div class="picture"><a href="style1/images/portfolio/portoflio-01-large.jpg" rel="image" title="Maritime Details"><img src="style1/images/portfolio/portoflio-01.jpg" alt=""/><div class="image-overlay-zoom"></div></a></div>
